...
volatile bool ishaaraStreamActive = false;
...
static esp_err_t capture_handler(httpd_req_t *req) {
  if (ishaaraCloudBusy) {
    ...
    return httpd_resp_sendstr(req, "Cloud recognition is using the camera");
  }
  camera_fb_t *fb = NULL;
  esp_err_t res = ESP_OK;
#if ARDUHAL_LOG_LEVEL >= ARDUHAL_LOG_LEVEL_INFO
